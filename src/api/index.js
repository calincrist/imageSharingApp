export default {
  ...
  fetchImages: (user = null) => {
    const images = [
      ...
      {id: 1, src: 'https://cdn.pixabay.com/user/2013/11/05/02-10-23-764_250x250.jpg', user: {pic: 'https://cdn.pixabay.com/photo/2014/08/20/07/58/girl-422333_960_720.jpg', name: 'Naia'}},
